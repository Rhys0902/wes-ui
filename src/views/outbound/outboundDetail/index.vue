    ...
    <div class="p-2">
            ...
            <el-card shadow="hover">
                <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="90px">
                    ...
                    <span v-show="showAllSearchTop">
                        ...
                        <el-form-item label="进货序号" prop="restockLineNumber">
                            <el-input v-model="queryParams.restockLineNumber" placeholder="请输入进货序号" clearable @keyup.enter="handleQuery" />
                        </el-form-item>
        ...
        <el-card shadow="hover">
            <el-row :gutter="10" class="mb8">
                <el-col :span="1.5">
                    <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['outbound:outboundDetail:add']">新增</el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate" v-hasPermi="['outbound:outboundDetail:edit']">修改</el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['outbound:outboundDetail:remove']">删除</el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['outbound:outboundDetail:export']">导出</el-button>
                </el-col>
                <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
            </el-row>

            <el-table v-loading="loading" :data="outboundDetailList" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="进货序号" align="center" prop="restockLineNumber" />
                ...
                <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200px">
                    <template #default="scope">
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['outbound:outboundDetail:edit']">修改</el-button>
                        <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['outbound:outboundDetail:remove']">删除</el-button>
                    </template>
                </el-table-column>
            </el-table>
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="outboundDetailRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="订单头ID" prop="headerId">
                ...
                <el-form-item label="进货序号" prop="restockLineNumber">
                    <el-input v-model="form.restockLineNumber" placeholder="请输入进货序号" />
                </el-form-item>
                <el-form-item label="采购序号" prop="purchaseLineNumber">
...
<script setup name="OutboundDetail">
import { listOutboundDetail, getOutboundDetail, delOutboundDetail, addOutboundDetail, updateOutboundDetail } from "@/api/outbound/outboundDetail"
...
function reset() {
    ...
    proxy.resetForm("outboundDetailRef")
}
...
/** 提交按钮 */
function submitForm() {
    proxy.$refs["outboundDetailRef"].validate(valid => {
        if (valid) {
            buttonLoading.value = true
            if (form.value.id != null) {
                updateOutboundDetail(form.value)
                    .then(response => {
...
function handleDelete(row) {
    ...
    proxy.$modal
        .confirm('是否确认删除出库明细编号为"' + _ids + '"的数据项？')
        .then(function () {
            loading.value = true
...
function handleExport() {
    proxy.download(
        "outbound/outboundDetail/export",
        {
            ...queryParams.value
        },
        `出库明细_${new Date().getTime()}.xlsx`
    )
}
