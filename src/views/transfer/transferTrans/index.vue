    ...
    <div class="p-2">
                ...
                <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="90px">
                    ...
                    <span v-show="showAllSearchTop">
                        ...
                        <el-form-item label="质检状态" prop="qcStatus">
                            <el-input v-model="queryParams.qcStatus" placeholder="请输入质检状态" clearable @keyup.enter="handleQuery" />
                        </el-form-item>
        ...
        <el-card shadow="hover">
            <el-row :gutter="10" class="mb8">
                <!-- <el-col :span="1.5">
                    <el-button type="primary" plain icon="Plus" @click="handleAdd" v-hasPermi="['transfer:transferTrans:add']">新增</el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="success" plain icon="Edit" :disabled="single" @click="handleUpdate" v-hasPermi="['transfer:transferTrans:edit']">修改</el-button>
                </el-col>
                <el-col :span="1.5">
                    <el-button type="danger" plain icon="Delete" :disabled="multiple" @click="handleDelete" v-hasPermi="['transfer:transferTrans:remove']">删除</el-button>
                </el-col> -->
                <el-col :span="1.5">
                    <el-button type="warning" plain icon="Download" @click="handleExport" v-hasPermi="['transfer:transferTrans:export']">导出</el-button>
                </el-col>
                <right-toolbar v-model:showSearch="showSearch" @queryTable="getList"></right-toolbar>
            </el-row>
            <el-table v-loading="loading" :data="transferTransList" @selection-change="handleSelectionChange" :default-sort="{prop: 'id', order: 'descending'}" @sort-change="handleSortChange">
                <!-- <el-table-column type="selection" width="55" align="center" /> -->
                <el-table-column label="主键ID" align="center" prop="id" v-if="false" />
                <!-- <el-table-column label="订单ID" align="center" prop="docId" sortable="custom" /> -->
                ...
                <!-- <el-table-column label="物料ID" width="150" align="center" prop="materialId" sortable="custom" /> -->
                ...
                <!-- <el-table-column label="源库位ID" width="150" align="center" prop="sourceLocId" sortable="custom" /> -->
                <el-table-column label="源库位" width="150" align="center" prop="sourceLocCode" sortable="custom" />
                <!-- <el-table-column label="目标库位ID" width="150" align="center" prop="targetLocId" sortable="custom" /> -->
                <el-table-column label="目标库位编码" width="150" align="center" prop="targetLocCode" sortable="custom" />
                <!-- <el-table-column label="源容器ID" width="150" align="center" prop="sourceLeId" sortable="custom" /> -->
                <el-table-column label="源容器编码" width="160" align="center" prop="sourceLeCode" sortable="custom" />
                <!-- <el-table-column label="目标容器ID" width="150" align="center" prop="targetLeId" sortable="custom" /> -->
                ...
                <!-- <el-table-column label="批次属性ID" width="150" align="center" prop="batchId" sortable="custom" /> -->
                ...
                <!-- <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="200px">
                    <template #default="scope">
                        <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['transfer:transferTrans:edit']">修改</el-button>
                        <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['transfer:transferTrans:remove']">删除</el-button>
                    </template>
                </el-table-column> -->
            </el-table>
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="transferTransRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="订单ID" prop="docId">
...
<script setup name="TransferTrans">
import { listTransferTrans, getTransferTrans, delTransferTrans, addTransferTrans, updateTransferTrans } from "@/api/transfer/transferTrans"

const { proxy } = getCurrentInstance()
const showAllSearchTop = ref(false)

const transferTransList = ref([])
...
function getList() {
    ...
    listTransferTrans(queryParams.value).then(response => {
        transferTransList.value = response.rows
...
function reset() {
    ...
    proxy.resetForm("transferTransRef")
}
...
function handleUpdate(row) {
    ...
    getTransferTrans(_id).then(response => {
        loading.value = false
...
/** 提交按钮 */
function submitForm() {
    proxy.$refs["transferTransRef"].validate(valid => {
        if (valid) {
            buttonLoading.value = true
            if (form.value.id != null) {
                updateTransferTrans(form.value)
                    .then(response => {
...
function handleDelete(row) {
    ...
    proxy.$modal
        .confirm('是否确认删除移库交易编号为"' + _ids + '"的数据项？')
        .then(function () {
            loading.value = true
            return delTransferTrans(_ids)
        })
        .then(() => {
            loading.value = true
            getList()
...
function handleExport() {
    proxy.download(
        "transfer/transferTrans/export",
        {
            ...queryParams.value
        },
        `移库交易_${new Date().getTime()}.xlsx`
    )
}
