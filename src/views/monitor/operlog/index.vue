    ...
    <div class="p-2">
        ...
        <el-card shadow="hover">
            <el-row :gutter="10" class="mb8">
                ...
                <el-col :span="1.5">
                    <el-button type="danger" plain icon="Brush" @click="handleClean" v-hasPermi="['monitor:operlog:remove']">清空</el-button>
                </el-col>
                <el-col :span="1.5">
            ...
            <el-table ref="operlogRef" v-loading="loading" :data="operlogList" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
                ...
                <el-table-column label="日志编号" width="180" align="center" prop="operId" :show-overflow-tooltip="true" />
                <el-table-column label="系统模块" width="180" align="center" prop="title" :show-overflow-tooltip="true" />
                ...
                <el-row>
                    ...
                    <el-col :span="24">
                        <el-form-item label="请求参数：">
                            <json-viewer v-if="form.operParam && isValidJson(form.operParam)" :value="JSON.parse(form.operParam)" :boxed="true" :expand-depth="2" :copyable="{
                                    copyText: '复制',
                                    copiedText: '复制成功!',
                                    timeout: 2000,
                            ...
                            <div v-else class="json-error">
                                {{ form.operParam || '无参数数据' }}
                            </div>
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="返回参数：">
                            <json-viewer v-if="form.jsonResult && isValidJson(form.jsonResult)" :value="JSON.parse(form.jsonResult)" :boxed="true" :expand-depth="2" :copyable="{
                                    copyText: '复制',
                                    copiedText: '复制成功!',
                                    timeout: 2000,
                                }" theme="my-awesome-json-theme">
