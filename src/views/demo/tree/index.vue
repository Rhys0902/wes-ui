<template>
    <div class="p-2">
        ...
        <el-table v-if="refreshTable" v-loading="loading" :data="treeList" row-key="id" :default-expand-all="isExpandAll" :tree-props="{children: 'children', hasChildren: 'hasChildren'}">
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="treeRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="父id" prop="parentId">
                    <treeselect v-model:value="form.parentId" :options="treeOptions" :objMap="{ value: 'id', label: 'true_name', children: 'children' }" placeholder="请选择父id" />
                </el-form-item>
...
function handleDelete(row) {
    proxy.$modal
        .confirm('是否确认删除测试单表编号为"' + row.id + '"的数据项?')
        .then(() => {
            loading.value = true
